...
public class EssSennecHomeV3BatteryImpl extends AbstractOpenemsComponent
		implements EssSennecHomeV3Battery, SymmetricEss, AsymmetricEss, OpenemsComponent, SinglePhaseEss, EventHandler {
	...
	public EssSennecHomeV3BatteryImpl() {
		super(//
