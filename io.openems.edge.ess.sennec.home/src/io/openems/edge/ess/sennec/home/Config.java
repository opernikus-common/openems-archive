...
@ObjectClassDefinition(//
		...
		description = "Implements the Sennec Home V3 Battery component (READ ONLY).")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Sennec Home V3 (READ ONLY)[{id}]";
